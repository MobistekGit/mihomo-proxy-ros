...
:do {add key=EXTERNAL_UI_URL list=MihomoProxyRoS value="https://github.com/Zephyruso/zashboard/releases/latest/download/dist-cdn-fonts.zip"
:put "Add env EXTERNAL_UI_URL value: dist-cdn-fonts.zip "} on-error {}
